...
<div id="page">
    ...
    <div class="gtco-section">
        <div class="gtco-container">
            <div class="row">
               <div style="color:red;font-family:'kaiti';font-size:23px;margin-left:500px;">餐饮超市</div>
                <div style="width:1380px;height:auto;margin-left:-100px;margin-top:50px;">
                    <form action="<?php echo U('Home/Goods/mycar');?>" method="post">
                        <?php if(is_array($goodsData)): foreach($goodsData as $key=>$v): ?><div class="table_content" style="width:260px;float:left;margin-left:10px;margin-bottom:50px;">
                                <div>
