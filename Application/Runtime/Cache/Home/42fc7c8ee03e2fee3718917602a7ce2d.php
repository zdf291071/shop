...
<style type="text/css">
    ...
    .list_content p input{
        border:none;
    }
    .list_content p #submit{
...
<div class="container">
    <div class="checkout-addr">
        ...
        <div class="list_content">
            <form method="post" action="/zws/index.php/home/list/re_list">
                <p><span>用&nbsp;户&nbsp;名：</span><input type="text" name="user" value="<?php echo ($user); ?>"/></p>
                <p><span>订&nbsp;单&nbsp;号：</span><input type="text" name="listid" value="<?php echo ($listid); ?>"/></p>
                <p><span>电&nbsp;&nbsp;&nbsp;&nbsp;话：</span><input type="text" name="phone" value="<?php echo ($phone); ?>"/></p>
                <p><span>地&nbsp;&nbsp;&nbsp;&nbsp;址：</span><input type="text" name="address" value="<?php echo ($address); ?>"/></p>
                <p><span>价&nbsp;&nbsp;&nbsp;&nbsp;格：</span><input type="text" name="price" value="<?php echo ($total); ?>"/></p>
                <div class="next-btn-wrap" >
                <p><input type="submit" style="color:red;" id="submit" class="btn btn--red" name="submit" value="确认订单"/></p>
                </div>
            </form>
        </div>
