...
<div id="content">
    ...
    <div class="content-wrapper">
        ...
        <!-- End .row -->
        <div class="outlet">
            <form name="theForm" id="demo" action="<?php echo U('admin/user/add_user');?>" method="post">
                <table style="border:1px solid #E0E0E0;" width="100%" bgcolor="White">
                    <tr>
                        <th align="right">用户名</td>
                        <td><input type="text" name="user" class="input_text" value="" /><span class="require-field">*</span></td>
                    </tr>
                    ...
                    <tr>
                        <th align="right">邮 箱</td>
                        <td><input type="text" class="input_text" size="34" maxlength="18" name="email"><span class="require-field">*</span></td>
                    </tr>

                    <tr>
                        <th align="right">phone</td>
                        <td><input type="text" name="phone" class="input_text" size="34" /><span class="require-field">*</span></td>
                    </tr>
