        ...
        <div class="outlet">
            ...
            <table border="1">
                ...
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td>
                            <?php if($vo['state']=='1'): ?>已发货
                                <?php else: ?>
                                未发货<?php endif; ?>
                        </td>
                        <td>
                            <a href="<?php echo U('admin/user/show_edit_user',array('id'=>$vo['id']));?>"><img style="width:16px;height:16px;" src="<?php echo (ADMIN_IMG_URL); ?>edit.png"/></a>|
                            <a href="<?php echo U('admin/user/delete_user',array('id'=>$vo['id']));?>"><img style="width:16px;height:16px;" src="<?php echo (ADMIN_IMG_URL); ?>del.png"/></a>
                        </td>
