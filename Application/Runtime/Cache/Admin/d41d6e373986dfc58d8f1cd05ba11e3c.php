...
<div id="content">
    ...
    <div class="content-wrapper">
        ...
        <!-- End .row -->
        <div class="outlet">
            <form name="theForm" id="demo" enctype="multipart/form-data" action="<?php echo U('admin/product/add_product');?>" method="post">
                <table style="border:1px solid #E0E0E0;" width="100%" bgcolor="White">
                    <tr>
                        <th align="right">商品名</td>
                        <td><input type="text" name="name" class="input_text" value="" /><span class="require-field">*</span></td>
                    </tr>

                    <tr>
                        <th align="right">商品单价</td>
                        <td><input type="text" class="input_text" size="34" maxlength="18" name="price"><span class="require-field">*</span></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="input_text" size="34" name="type" /><span class="require-field">*</span></td>
                    </tr>
