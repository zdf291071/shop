        ...
        <div class="outlet">
          ...
          <table border="1">
              ...
              <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                      ...
                      <?php if($v['role_user'] == 1): ?><td>管理员</td><?php endif; ?>
                      <td><a href="/zws/index.php/admin/admin/edit_admin?id=<?php echo ($v["id"]); ?>"><img style="width:16px;height:16px;" src="<?php echo (ADMIN_IMG_URL); ?>edit.png"/></a>|<a href="/zws/index.php/admin/admin/del_admin?id=<?php echo ($v["id"]); ?>"><img style="width:16px;height:16px;" src="<?php echo (ADMIN_IMG_URL); ?>del.png"/></a></td>
