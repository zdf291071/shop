    ...
    <div class="content-wrapper">
        ...
        <div class="outlet">
            ...
            <table border="1">
                ...
                <tbody>
                <?php if(is_array($productTypeModelArr)): foreach($productTypeModelArr as $key=>$vo): ?><tr>
                        <td><input type="checkbox" name="c1"/></td>
                        <td><?php echo ($vo['id']); ?></td>
                        <td><?php echo ($vo['name']); ?></td>
                        <td>
                            <a href="/zws/index.php/admin/product/edit_product_type?id=<?php echo ($v["id"]); ?>">
                                <img style="width:16px;height:16px;" src="<?php echo (ADMIN_IMG_URL); ?>edit.png"/></a>|
                            <a href="/zws/index.php/admin/product/delete_product_type?id=<?php echo ($v["id"]); ?>">
