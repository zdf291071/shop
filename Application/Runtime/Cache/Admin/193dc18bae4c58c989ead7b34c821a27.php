...
<div id="content">
    ...
    <div class="content-wrapper">
        ...
        <!-- End .row -->
        <div class="outlet">
            <form name="theForm" id="demo" action="<?php echo U('admin/admin/add_admin_zx');?>" method="post">
                <table style="border:1px solid #E0E0E0;" width="100%" bgcolor="White">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="input_text" size="34" name="phone" /><span class="require-field">*</span></td>
                    </tr>
